...
'''
///*-=============================================================================================-*
/// Dateiname             : Mein_erster_Telegram_Bot.py
/// Version               : 1.0.0.0
/// Beginn                : 2024-02-21 (1402/12/02)
/// Letzte Aktualisierung : 2024-02-25 (1402/12/06)
...
/// ----------------------------------------------------------------------------------------------
///
/// Beschreibung: Lernen Sie PW Skills Tech von YouTube. So erstellen Sie einen Telegram-Bot mit 
///               Python von der Website (https://www.youtube.com/watch?v=Agkf4hEprwE/)
///               Kompilieren und führen Sie Code mit PythonAnywhere von Anaconda 
///               (https://www.pythonanywhere.com/) und der besten Anleitung mit ChatGPT4 aus.
///
///-=============================================================================================-*///
'''
#endregion
...
async def Start_Commmand(update, context):
    await update.message.reply_text(
        """
        Hallo! Willkommen beim Mein zweiter Telegram BOT.

        To get help run /Help command.
        """
    )
...
async def Help_Commmand(update, context):
    await update.message.reply_text(
        ...
        /help2 - Show the other commands list
        """
    )

'''
/// About_Commmand() Funktion zum Anzeigen der Telegram BOT-Hilfe
/// HINZUFÜGEN durch Ingenieur B.Pourtavakoli im 1402/12/06
'''
async def About_Commmand(update, context):
    await update.message.reply_text("Welcome to the Behdad Software Developers Group™ Production\n\n" +

        "My first Telegram Bot - Created by @BotFather and developed by Python.\n\n" +

        "Copyright© 1380-1402,2001-2024 by B.S.D Group™\n" +
        "All rights reserved.\n\n" +

        "Design and develop by Engineer Behdad Pourtavakoli.\n\n" +

        "Contact with developer: https://t.me/Behdad_pourtavakoli\n" +
        "———————————————————————————————\n" +
        "Willkommen bei der Behdad Software Developers Group™ Produktion\n\n" +

        "Mein erster Telegram Bot - Erstellt von @BotFather und entwickelt von Python.\n\n" +

        "Urheberrecht© 1380-1402,2001-2024 bei B.S.D Group™\n" +
        "Alle Rechte vorbehalten.\n\n" +

        "Design und Entwicklung durch Ingenieur Behdad Pourtavakoli.\n\n" +

        "Kontakt mit Entwickler: https://t.me/Behdad_pourtavakoli\n")
...
/// HINZUFÜGEN durch Ingenieur B.Pourtavakoli im 1402/12/02
'''
def BOT_Get_ShortInfo(strBOT_Token):
...
/// HINZUFÜGEN durch Ingenieur B.Pourtavakoli im 1402/12/02
'''
def BOT_Get_Updates(strBOT_Token):
...
def WinMain():
    ...
    ## data = BOT_Get_Updates(TOKEN)
    ## print("BOT Updates: ", data, '\n\n', sep='', end='')
    ## data = BOT_Get_ShortInfo(TOKEN)
    ## print("BOT Updates: ", data, '\n\n', sep='', end='')
    ## exit()
    ...
    application.add_handler(CommandHandler('about', About_Commmand))
